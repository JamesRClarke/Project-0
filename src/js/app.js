$(() => {
  ...
  const categories = {
    ...
    TUBE: ['acton town','acton central','aldgate', 'aldgate east', 'alperton','amersham','angel','amersham','angel','archway', 'arnos grove','arsenal','baker street','balham','bank','barbican','barking','barkingside','barons court','bayswater','becontree','belsize park','bermondsey','bethnal green','blackfriars','blackhorse road','bond street','borough','boston manor','bounds green','bow road','brent cross','brixton','bromley by bow', 'brondesbury','brondesbury park','buckhurst hill','burnt oak','caledonian road','caledonian road & barnesbury','camden road','camden town','canada water','canary wharf','cannon street','canonbury','canons park','chalfont & latimer','chalk farm','chancery lane','charing cross','chesham','chigwell','chiswick park','chorleywood','city thameslink','clapham common','clapham north','clapham south','cockfosters','colindale','colliers wood','covent garden','croxley','dagenham east','dagenham heathway','dalston kingsland','debden','dollis hill','ealing broadway','ealing common','earls court','east acton','east finchley','east ham','east putney','eastcote','edgeware road','elephant & castle'],
    TEST: ['caledonian road & barnesbury','anagram', 'aszneee and coworker reunion bro']
